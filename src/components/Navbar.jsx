      ...
      {isVisible && (
        ...
        >
          ...
          >
            ...
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <button
                ...
                className={`hover:text-[#795EF6] cursor-pointer transition-colors ${isActive("services")}`}
              >
                Services
              </button>
              <button
              ...
              <button
                ...
                className={`hover:text-[#795EF6] cursor-pointer transition-colors ${isActive("casestudies")}`}
              >
                Success Stories
              </button>
            </nav>
            ...
            >
              <span
                className={`w-6 h-0.5 bg-white mb-1.5 transition-all ${isMobileMenuOpen ? "rotate-45 translate-y-2" : ""}`}
              ></span>
              <span
                className={`w-6 h-0.5 bg-white mb-1.5 transition-all ${isMobileMenuOpen ? "opacity-0" : ""}`}
              ></span>
              <span
          ...
          <AnimatePresence>
            {isMobileMenuOpen && (
              <motion.div
                className="fixed top-[-10px] right-[-10px] h-[90vh] w-64 bg-gray-900/95 backdrop-blur-md md:hidden overflow-y-auto"
                initial="closed"
                animate="open"
                exit="closed"
              ...
              >
                <div className="flex flex-col items-center justify-center min-h-full py-20 space-y-6">
                  ...
                  <button
                    ...
                    className={`text-xl hover:text-[#795EF6] transition-colors ${isActive("services")}`}
                  >
                    Services
                  </button>
                  <button
                  ...
                  <button
                    onClick={() => {
                      scrollToSection("casestudies");
                      setIsMobileMenuOpen(false);
                    }}
                    className={`text-xl hover:text-[#795EF6] transition-colors ${isActive("casestudies")}`}
                  >
                    Success Stories
                  </button>
                  <button
